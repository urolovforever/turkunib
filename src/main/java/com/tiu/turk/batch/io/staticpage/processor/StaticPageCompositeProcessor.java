...
import com.tiu.turk.batch.io.staticpage.processor.StaticPageTaskToPayloadProcessor;
...
@Component
public class StaticPageCompositeProcessor
implements ItemProcessor<TranslationTaskEntity, TranslationResult> {
    private final StaticPageTaskToPayloadProcessor taskToPayloadProcessor;
    ...
    @Generated
    public StaticPageCompositeProcessor(StaticPageTaskToPayloadProcessor taskToPayloadProcessor, OpenAiTranslateProcessor openAiTranslateProcessor, ValidateSourcePayloadProcessor validateSourcePayloadProcessor) {
