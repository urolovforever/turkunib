...
public class NewsEntity {
    ...
    @MapKey(name="locale")
    private Map<TranslationLocale, NewsTranslationEntity> translations = new EnumMap(TranslationLocale.class);
    ...
    @Generated
    public Map<TranslationLocale, NewsTranslationEntity> getTranslations() {
    ...
    @Generated
    public void setTranslations(Map<TranslationLocale, NewsTranslationEntity> translations) {
